...
/**
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
     System.out.println(this.jList1.getSelectedIndex());
        Fornecedor f1 = (Fornecedor) this.jList1.getSelectedValuesList();
            Repositorio.fornecedores.remove(f1);
            listarFornecedor();   // TODO add your handling code here:
    ...
    private void listarFornecedor() {
        ...
        Modelo.clear();
        Modelo.addAll(Repositorio.fornecedores);
